...
public class Assignment1 {
    public static void main(String[] args) {
        final double ConversionFactor = (5.0 / 9.0);   //Used to convert Fahrenheit to Celsius and vice versa
        ...
        float TempCelsius = (float) ((TempFahrenheit - 32) * ConversionFactor); //Converts Fahrenheit to Celsius
